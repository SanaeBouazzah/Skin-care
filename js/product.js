...
function addtocart(pro) {
    ...
    img.setAttribute('src', pro.children[0].children[0].currentSrc);
    var title = document.createElement('div');
    title.innerText = pro.children[1].children[0].innerText;
    var price = document.createElement('div');
    price.innerText = pro.children[1].children[2].innerText;
